...
?>
  ...
  $(document).ready(function(){
    $(".page-title").append("Clients");
    document.title = "Dashboard - Clients";
    $.ajax(
    {
        url:'../ajax/ViewClients.php',
        method:'POST',
        ...
        <div class="modal modal-blur fade" id="ModalRemove" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Are you sure?</h3>
                    <div class="text-muted">Do you really want to delete this Client?<br> What you've done cannot be undone.</div>
                </div>
        ...
        <div class="modal modal-blur fade" id="ModalAccessDenied" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">You don't have permission to delete clients.</div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
        ...
        <div class="modal modal-blur fade" id="ModalReplySuccess" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Email Sent!</h3>
                    <div class="text-muted">Your email has been sent successfully to client.</div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                    <div class="row">
