...
?>
  ...
  $(document).ready(function(){
    $(".page-title").append("Contacts");
    document.title = "Dashboard - Contacts";
    $.ajax(
    {
        url:'../ajax/ViewContacts.php',
        method:'POST',
        ...
        <div class="modal modal-blur fade" id="ModalAccessDenied" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">You don't have permission to delete contact messages.</div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
