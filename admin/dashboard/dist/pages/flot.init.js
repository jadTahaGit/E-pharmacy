...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var pcolors = ['#f0f1f4', '#4b57bf', '#02a461'];
          ...
          var datas = [20,30, 15];
          var colors = ['#02a461','#4b57bf', "#ebeff2"];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#02a461']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ['#f0f1f4', '#02a461', '#4b57bf'];
