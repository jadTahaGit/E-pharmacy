...
?>
  ...
  $(document).ready(function(){
    $(".page-title").append("Stock");
    document.title = "Dashboard - Stock";
    $.ajax(
    {
        url:'../ajax/ViewStock.php',
        method:'POST',
        ...
        <div class="modal modal-blur fade" id="ModalEdit" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Edit Medicine Quantity</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Quantity</label>
                        <input type="text" class="form-control" id="med_quantity" name="med_quantity" placeholder="Medicine quantity" autocomplete="off" onkeydown="return ( event.ctrlKey || event.altKey 
        ...
        <div class="modal modal-blur fade" id="ModalAccessDenied" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">You don't have permission to edit stock.</div>
                </div>
        ...
        <div class="modal modal-blur fade" id="ModalEditSuccess" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">Medicine Quantity Successfully Updated.</div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                    <div class="row">
...
<script>
    ...
    {
        $(document).ready(function(){
            document.getElementById("med_quantity").value = name;
            var modal = `
    ...
    function goEdit(id)
    {
        var qty = document.getElementById("med_quantity").value;
        $.ajax(
        {
            url:'../ajax/EditStock.php',
            method:'POST',
            data:{
                id: id,
                qty: qty
