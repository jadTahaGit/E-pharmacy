...
?>
  ...
  $(document).ready(function(){
    $(".page-title").append("Admins");
    document.title = "Dashboard - Admins";
    $.ajax(
    {
        url:'../ajax/ViewAdmins.php',
        method:'POST',
        ...
        <div class="modal modal-blur fade" id="ModalRemove" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Are you sure?</h3>
                    <div class="text-muted">Do you really want to delete this Admin?<br> What you've done cannot be undone.</div>
                </div>
