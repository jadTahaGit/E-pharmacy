...
?>
  ...
  $(document).ready(function(){
    $(".page-title").append("Types");
    document.title = "Dashboard - Types";
    $.ajax(
    {
        url:'../ajax/ViewTypes.php',
        method:'POST',
        ...
        <div class="modal modal-blur fade" id="ModalAccessDenied" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">You don't have permission to edit or delete types.</div>
                </div>
        ...
        <div class="modal modal-blur fade" id="ModalRemove" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon mb-2 text-danger icon-lg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 9v2m0 4v.01" /><path d="M5 19h14a2 2 0 0 0 1.84 -2.75l-7.1 -12.25a2 2 0 0 0 -3.5 0l-7.1 12.25a2 2 0 0 0 1.75 2.75" /></svg>
                    <h3>Are you sure?</h3>
                    <div class="text-muted">Do you really want to delete this Type?<br>All medicenes linked to this type will be deleted.<br> What you've done cannot be undone.</div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="type_name" name="type_name" placeholder="Type name" autocomplete="off">
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal modal-blur fade" id="ModalEditSuccess" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">Type Successfully Updated.</div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                    <div class="row">
