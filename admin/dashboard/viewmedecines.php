...
?>
  ...
  $(document).ready(function(){
    $(".page-title").append("Medicines");
    document.title = "Dashboard - Medicines";
    $.ajax(
    {
        url:'../ajax/ViewMedecines.php',
        method:'POST',
        ...
        <div class="modal modal-blur fade" id="ModalRemove" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Are you sure?</h3>
                    <div class="text-muted">Do you really want to delete this Medicine?<br> What you've done cannot be undone.</div>
                </div>
        ...
        <div class="modal modal-blur fade" id="ModalAccessDenied" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">You don't have permission to edit or delete medicines.</div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="medecine_name" name="medecine_name" placeholder="Medicine name" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Price</label>
                        <input type="text" class="form-control" id="price" name="price" placeholder="Medicine price" autocomplete="off" onkeydown="return ( event.ctrlKey || event.altKey 
...
<script>
    ...
    {
        $(document).ready(function(){
            var des = "description_"+id;
            document.getElementById("medecine_name").value = name;
