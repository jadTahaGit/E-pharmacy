<?php
    ...
    $res = getItems("medcine.id as med_id,medcine.name as med_name,price,picture_front","type,medcine","type.id=medcine.type_id and type.id='$categ' order by $sort_by limit $limit offset $offset");
    $result = "";
