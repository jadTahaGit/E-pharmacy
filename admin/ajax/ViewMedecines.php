<?php
    ...
    {
        $res = getAllItems("medcine");
        while($row = mysqli_fetch_row($res))
        {
            echo '
                <tr id="row_'.$row[0].'">
                    <td id="medname_'.$row[0].'" style="width: 80%;">'.$row[2].'</td>
                    <td style="width: 10%;" align="center"><button class="btn btn-primary" name="edit" id="edit_'.$row[0].'" onClick="edit('.$row[0].',`'.$row[2].'`,`'.$row[3].'`,`'.$row[4].'`)">&nbsp;&nbsp;&nbsp;
