<?php
    ...
    $nbr = getItems("id as med_id,name as med_name,description as med_description,price,picture_front","medcine","name like '%$keyword%' order by $sort_by limit $limit offset $offset_check");
    $nbr_rows = mysqli_num_rows($nbr);
    $res = getItems("id as med_id,name as med_name,description as med_description,price,picture_front","medcine","name like '%$keyword%' order by $sort_by limit $limit offset $offset");
    $result = "";
    if(mysqli_num_rows($res) > 0)
    {
                    ...
                    <div class="product-thumb">
                        ...
                        <div class="product-details-box" style="overflow: hidden">
                            ...
                            <div class="pull-right">
                                <button id="like" onClick="LoginStatus('.$row["med_id"].');" type="button" class="btn wish_button wish_button btn-default reg_button"><i class="fa fa-heart"></i></button>
        ...
        $("#btn_next").click(function(){
            ...
            $.ajax(
            {
                url:"admin/ajax/GetSearchListView.php",
                method:"POST",
                data: {
                    keyword: keyword,
                    sort: sort,
    ...
    {
        $result = "<h1 align=center>No result found.</h1>";
    }
    echo $result;
?>